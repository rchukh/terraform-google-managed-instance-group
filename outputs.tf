...
output instance_group {
  ...
  value       = concat(google_compute_instance_group_manager.default.*.instance_group, list(""))[0]
}
...
output region_instance_group {
  ...
  value       = concat(google_compute_region_instance_group_manager.default.*.instance_group, list(""))[0]
}
...
output depends_id {
  ...
  value       = concat(null_resource.dummy_dependency.*.id, list(""))[0]
}
...
output region_depends_id {
  ...
  value       = concat(null_resource.region_dummy_dependency.*.id, list(""))[0]
}
...
output health_check {
  ...
  value       = concat(google_compute_health_check.mig-health-check.*.self_link, list(""))[0]
}
